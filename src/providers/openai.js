  ...
  async translate(text, targetLang) {
    try {
      ...
      const response = await this.client.chat.completions.create({
        ...
        messages: [
          { role: 'system', content: 'You are a helpful assistant that translates text only, without any extra commentary. Keep all placeholders like @variable and {variable} exactly as they are.' },
